🩸 Blood Bank Management System (Python GUI)

A smart Blood Bank Management System built using Python that focuses on speed, accessibility, and emergency response efficiency. The system enables users to search blood availability, request donations, and track request status, while integrating features like email verification, location mapping, and QR-based processing.
...
Designed with emergency use-case in mind (speed-first workflow)
Hybrid system combining GUI + web rendering (maps)
Modular structure ready for real-time data integration
Simulation of real-world hospital/blood bank processes
Focus on user experience during critical situations
...
PyWeb (Web rendering inside Python GUI)
Leaflet.js (Map visualization)
customtkinter for frontend UI
...
Future scope :
🌐 Convert into full web application (HTML, CSS, JS)
⚙️ Backend using Spring Boot + Spring Security
📡 Real-time blood availability integration
🏥 Integration with hospitals and blood banks APIs
🔔 Live notifications for request updates
